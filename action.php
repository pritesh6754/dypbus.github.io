...
<TD><a href="#" class="ABCD" id="<?php echo $row['Aid']; ?>"><button class="btn btn-sm btn-danger"> X </button></a>
<a href="#" class="Edit" id="<?php echo $row['Aid']; ?>"><button class="btn btn-sm btn-primary"> Edit </button></a>
</TD>
</TR>
<?php
}
