...
{
$id=$_POST['ide'];
$select_table = "select * from busstudent where bsid=".$id;
...
<td><b>Route</b></td>
<td><b>Location</b></td>
<td><b>In DateTime</b></td>
<td><b>Out DateTime</b></td>
<td></td>
</tr></thead>
<tbody>
<?PHP
...
if(isset($_POST['route']))
{
	$Route=$_POST['route'];
					...
					$per_page = 10; 
					$select_table = "select * from busstudent,allstudent where busstudent.sid=allstudent.sid and bdatetime like '%".$searchid."%' and busstudent.bid='$Route'";
					$fetch= mysql_query($select_table);
...
<TD><?php echo $row['bdatetimeout']; ?></TD>
<TD><a href="#" class="ABCD" id="<?php echo $row['bsid']; ?>"><button class="btn btn-sm btn-danger"> X </button></a>
</TD>
</TR>
<?php
}
